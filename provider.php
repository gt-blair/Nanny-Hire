    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <h3 class="text-center">Update Nanny Information</h3>
            </div>
            <hr>
            ...
            <form action="scripts/updatehall.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input value="<?= $nanny->contact2; ?>"
                        id="contact2" name="contact2" type="text" class="form-control" placeholder="Contact No. 2"
                        required>
                </div>
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    <textarea name="descr" id="descr" class="form-control" cols="30" rows="5"
                        ...
                        required><?= $nanny->descr; ?></textarea>
                </div>

                <div class="form-group">
                    <label for="">Password</label>
                    <input value="<?= $nanny->password; ?>"
